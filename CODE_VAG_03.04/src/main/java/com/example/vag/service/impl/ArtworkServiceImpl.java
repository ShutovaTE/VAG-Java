...
public class ArtworkServiceImpl implements ArtworkService {
    ...
    public ArtworkServiceImpl(ArtworkRepository artworkRepository, CategoryRepository categoryRepository,
                              LikeRepository likeRepository, FileUploadUtil fileUploadUtil) {
    ...
    public boolean isLikedByUser(Artwork artwork, User user) {
        return likeRepository.findByArtworkAndUser(artwork, user).isPresent();
    }
